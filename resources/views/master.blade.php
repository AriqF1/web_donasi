                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->is('ngamal*') ? 'active' : '' }}"
                                        href="/ngamal">Ngamal</a>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <div class="dropdown">
                                        <a href="#" data-bs-toggle="dropdown" class="text-decoration-none"
                                            ...
                                            <img src="{{ asset('storage/profile-pictures/default.png') }}"
                                                alt="Profile Picture" class="rounded-circle" height="40">
                                            <span class="ms-2 text-black inter-medium">{{ auth()->user()->name }}</span>
                                        </a>
